...
public class ProjectPortfolio_1T_1MP_Overflow_Test {
    ...
    public void setUp() throws Exception {
        java.nio.file.Path resPath = java.nio.file.Paths.get( getClass().getResource("/002 One-team-one-mhproject-with-overflow.xlsx").toURI());
