...
public class ProjectPortfolio_1T_1SP_Test {
	...
	public void setUp() throws Exception {
        java.nio.file.Path resPath = java.nio.file.Paths.get( getClass().getResource("/007 One-team-one-strategic-project.xlsx").toURI());
	...
	public void test1T1MP() {
		...
		works.add(new ProjectTeamWork(BigDecimal.valueOf(10), "Project1", "Team1", new LocalDate(2016, 6, 1)));
		works.add(new ProjectTeamWork(BigDecimal.valueOf(10), "Project1", "Team1", new LocalDate(2016, 5, 1)));
		works.add(new ProjectTeamWork(BigDecimal.valueOf(10), "Project1", "Team1", new LocalDate(2016, 4, 1)));
		...
		try {
			...
			while(projectIterator.hasNext()) {
				...
				if(project.getProjectType().getProjectTypeCode().equals("SP") && project.getName().equalsIgnoreCase("Project1")) {
					...
					assertEquals("2016-09-01", project.getDeadlineMonth().toString());
				}
